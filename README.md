...
The text you need to change is (replacing the text `[https://github.com/mertoksuz/Signaloid-Demo-General-C]`):
```html
[<img src="https://assets.signaloid.io/add-to-signaloid-cloud-logo-dark-v6.svg#gh-dark-mode-only" alt="[Add to signaloid.io]" height="30">](https://signaloid.io/repositories?connect=https://github.com/mertoksuz/Signaloid-Demo-General-C#gh-dark-mode-only)
[<img src="https://assets.signaloid.io/add-to-signaloid-cloud-logo-light-v6.svg#gh-light-mode-only" alt="[Add to signaloid.io]" height="30">](https://signaloid.io/repositories?connect=[<your repository URL here>](https://github.com/mertoksuz/Signaloid-Demo-General-C)#gh-light-mode-only)
```
